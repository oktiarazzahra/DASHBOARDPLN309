...
echo "=== Testing Dashboard Query for SEMUA ULP ===\n\n";
...
$firstCategory = $detailData->first()->tarif_category ?? null;
echo "First category: {$firstCategory}\n";
echo "Expected: S (harus dimulai dari kategori S)\n";
